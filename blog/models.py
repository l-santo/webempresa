...
class Category(models.Model):
    ...
    created=models.DateTimeField(auto_now_add=True, verbose_name="Frecha de creacion")
...
class Blog(models.Model):
    ...
    categories=models.ManyToManyField(Category, verbose_name="Categorias") # muchos a muchos
